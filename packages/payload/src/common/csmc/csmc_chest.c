...
static const ChestCsmcData kCsmcData[] = {
    ...
    { 1, CUSTOM_CHESTS_MAJOR_FRONT_VROM,    CUSTOM_CHESTS_MAJOR_SIDE_VROM },
    { 1, CUSTOM_CHESTS_KEY_FRONT_VROM,      CUSTOM_CHESTS_KEY_SIDE_VROM },
    { 1, CUSTOM_CHESTS_SPIDER_FRONT_VROM,   CUSTOM_CHESTS_SPIDER_SIDE_VROM },
    { 1, CUSTOM_CHESTS_FAIRY_FRONT_VROM,    CUSTOM_CHESTS_FAIRY_SIDE_VROM },
    { 1, CUSTOM_CHESTS_HEART_FRONT_VROM,    CUSTOM_CHESTS_HEART_SIDE_VROM },
    { 0, CHEST_TEX_BOSS_KEY_FRONT, CHEST_TEX_BOSS_KEY_SIDE },
};
